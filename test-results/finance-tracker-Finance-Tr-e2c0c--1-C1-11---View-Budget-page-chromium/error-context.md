...
- Name: finance-tracker.spec.js >> Finance Tracker E2E Tests - 2 Cycles >> Cycle 1 >> C1.11 - View Budget page
- Location: e2e\finance-tracker.spec.js:228:11
...
> 235 |         await expect(page.locator('text=Budget')).toBeVisible({ timeout: 5000 });
  ...
  323 |           console.log(`✅ [Cycle ${cycle}] User logged out`);
  324 |         } else {
  325 |           console.log(`⚠️ [Cycle ${cycle}] Logout button not found`);
  326 |         }
  327 | 
